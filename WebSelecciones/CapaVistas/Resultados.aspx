<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resultados.aspx.cs" Inherits="WebSelecciones.CapaVistas.Resultados" %>
...
<asp:Label ID="resultadoLabel" runat="server" Text="Label"></asp:Label>
